            ...
            (function(t) {
                (function() {
                    ...
                    function v(t, e, s) {
                        ...
                        s.valueDiffing && (t.value && b(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (i.value = t.value),
                        t.checked && b(i, "HTMLInputElement") && (i.checked = t.checked),
                        t.selected && b(i, "HTMLOptionElement") && (i.selected = t.selected))),
                        i
                    }
                    var w = function(t, e) {
                    ...
                    function _(t, e, s) {
                        ...
                        [s._const.addElement, s._const.addTextElement].includes(o) || (i = w(t, r));
                        var l = {
                            diff: e,
                            node: i
                        };
                        ...
                        case s._const.modifyAttribute:
                            ...
                            b(i, "HTMLInputElement") && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.modifyTextElement:
                            ...
                            b(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.relocateGroup:
                            m([], new Array(e[s._const.groupLength]), !0).map((function() {
                        ...
                        case s._const.addElement:
                            ...
                            if (!b(i = w(t, u), "Element"))
                                return !1;
                            i.insertBefore(v(e[s._const.element], "http://www.w3.org/2000/svg" === i.namespaceURI, s), i.childNodes[c] || null);
                            break;
                        ...
                        case s._const.addTextElement:
                            var u;
                            if (c = (u = r.slice()).splice(u.length - 1, 1)[0],
                            n = s.document.createTextNode(e[s._const.value]),
                            !(i = w(t, u)).childNodes)
                                return !1;
                            i.insertBefore(n, i.childNodes[c] || null),
                            b(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.value]);
                            break;
                        default:
                    ...
                    var D = function(t) {
                      ...
                      , O = function(t) {
                        ...
                        return Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = f({}, t.attributes)),
                      ...
                      , C = function(t, e) {
                        for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = $(s.length, !1), a = $(i.length, !1), o = [], r = function() {
                            return arguments[1]
                        }, l = !1, d = function() {
                            var t = function(t, e, s, i) {
                                ...
                                for (var h = 0; h < o; h++)
                                    for (var u = t[h], p = 0; p < r; p++) {
                                        var f = e[p];
                                        s[h] || i[p] || !V(u, f, d, c) ? l[h + 1][p + 1] = 0 : (l[h + 1][p + 1] = l[h][p] ? l[h][p] + 1 : 1,
                            ...
                            t ? (o.push(t),
                            m([], new Array(t.length), !0).map(r).forEach((function(e) {
                                return function(t, e, s, i) {
                                    t[s.oldValue + i] = !0,
                                    e[s.newValue + i] = !0
                                }(n, a, t, e)
                    ...
                    function A(t, e) {
                        ...
                        return b(t, "Text", "Comment") ? s.data = t.data : (t.attributes && t.attributes.length > 0 && (s.attributes = {},
                        Array.prototype.slice.call(t.attributes).forEach((function(t) {
                            return s.attributes[t.name] = t.value
                        }
                        ))),
                        t.childNodes && t.childNodes.length > 0 && (s.childNodes = [],
                        Array.prototype.slice.call(t.childNodes).forEach((function(t) {
                            return s.childNodes.push(A(t, e))
                        }
                        ))),
                        e.valueDiffing && (b(t, "HTMLTextAreaElement") && (s.value = t.value),
                        b(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : b(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value),
                        b(t, "HTMLOptionElement") && (s.selected = t.selected))),
                        s
                    }
                    var L = /<\s*\/*[a-zA-Z:_][a-zA-Z0-9:_\-.]*\s*(?:"[^"]*"['"]*|'[^']*'['"]*|[^'"/>])*\/*\s*>|<!--(?:.|\n|\r)*?-->/g
                      , P = /\s([^'"/\s><]+?)[\s/>]|([^\s=]+)=\s?(".*?"|'.*?')/g;
                    function R(t) {
                    ...
                    var H = {
                      ...
                      , Y = function(t, e) {
                        ...
                        return t.replace(L, (function(r, l) {
                            var d = "/" !== r.charAt(1)
                              , c = r.startsWith("\x3c!--")
                              , h = l + r.length
                              , u = t.charAt(h);
                            ...
                            if (d) {
                                if ("svg" === (s = I(r, e.caseSensitive || o)).node.nodeName && (o = !0),
                                n++,
                                !s.voidElement && u && "<" !== u) {
                      ...
                      , j = function() {
                        function t(t, e, s) {
                            this.options = s,
                            this.t1 = "undefined" != typeof Element && b(t, "Element") ? A(t, this.options) : "string" == typeof t ? Y(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2 = "undefined" != typeof Element && b(e, "Element") ? A(e, this.options) : "string" == typeof e ? Y(e, this.options) : JSON.parse(JSON.stringify(e)),
                            this.diffcount = 0,
                            this.foundAll = !1,
                            this.debug && (this.t1Orig = "undefined" != typeof Element && b(t, "Element") ? A(t, this.options) : "string" == typeof t ? Y(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2Orig = "undefined" != typeof Element && b(e, "Element") ? A(e, this.options) : "string" == typeof e ? Y(e, this.options) : JSON.parse(JSON.stringify(e))),
                            this.tracker = new S
                        }
                        ...
                        t.prototype.findDiffs = function(t, e) {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (E(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
                                x(t),
                        ...
                        t.prototype.findOuterDiff = function(t, e, s) {
                            ...
                            if (t.nodeName !== e.nodeName) {
                                ...
                                return [(new g).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(t)).setValue(this.options._const.newValue, O(e)).setValue(this.options._const.route, s)]
                            }
                            ...
                            if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                                return "#text" === t.nodeName ? [(new g).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)] : [(new g).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
                            for (n = t.attributes ? Object.keys(t.attributes).sort() : [],
                            a = e.attributes ? Object.keys(e.attributes).sort() : [],
                            o = n.length,
                            l = 0; l < o; l++)
                                i = n[l],
                                -1 === (r = a.indexOf(i)) ? d.push((new g).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1),
                                t.attributes[i] !== e.attributes[i] && d.push((new g).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                            for (o = a.length,
                            l = 0; l < o; l++)
                                i = a[l],
                                d.push((new g).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                            return d
                        }
                        ,
                        t.prototype.findInnerDiff = function(t, e, s) {
                            ...
                            if (!this.options.maxChildCount || a < this.options.maxChildCount) {
                                var d = Boolean(t.subsets && t.subsetsAge--)
                                  , c = d ? t.subsets : t.childNodes && e.childNodes ? C(t, e) : [];
                            ...
                            for (var h = 0; h < a; h += 1) {
                                var u = i[h]
                                  , p = n[h];
                                o && (u && !p ? "#text" === u.nodeName ? (r.push((new g).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)),
                                l -= 1) : (r.push((new g).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, O(u))),
                                l -= 1) : p && !u && ("#text" === p.nodeName ? r.push((new g).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, p.data)) : r.push((new g).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, O(p))))),
                                ...
                                h -= 1,
                                l -= 1,
                                o -= 1) : i.length < n.length ? (r = r.concat([(new g).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, O(p)).setValue(this.options._const.route, s.concat(l))]),
                                i.splice(h, 0, O(p)),
                                o -= 1) : r = r.concat([(new g).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(u)).setValue(this.options._const.newValue, O(p)).setValue(this.options._const.route, s.concat(l))]))),
                                l += 1
                            }
                        ...
                        t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
                            for (var a, o, r, l, d, c = function(t, e, s) {
                                var i = t.childNodes ? $(t.childNodes.length, !0) : []
                                  , n = e.childNodes ? $(e.childNodes.length, !0) : []
                                  , a = 0;
                            ...
                            }(t, e, s), h = c.gaps1, u = c.gaps2, p = t.childNodes.slice(), f = e.childNodes.slice(), m = Math.min(h.length, u.length), b = [], v = 0, w = 0; v < m; w += 1,
                            v += 1)
                                if (!n || !0 !== h[v] && !0 !== u[v])
                                    if (!0 === h[w])
                                        if ("#text" === (l = p[w]).nodeName)
                                            if ("#text" === f[v].nodeName) {
                                                if (l.data !== f[v].data) {
                                                    ...
                                                    d || b.push((new g).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, f[v].data))
                                                }
                                            } else
                                                b.push((new g).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)),
                                                h.splice(w, 1),
                                                p.splice(w, 1),
                                            ...
                                            !0 === u[v] ? b.push((new g).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(l)).setValue(this.options._const.newValue, O(f[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new g).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, O(l))),
                                            h.splice(w, 1),
                                            p.splice(w, 1),
                                            m = Math.min(h.length, u.length),
                                            w -= 1,
                                        ...
                                        "#text" === (l = f[v]).nodeName ? (b.push((new g).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)),
                                        h.splice(w, 0, !0),
                                        p.splice(w, 0, {
                                            nodeName: "#text",
                                            data: l.data
                                        }),
                                        m = Math.min(h.length, u.length)) : (b.push((new g).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, O(l))),
                                        h.splice(w, 0, !0),
                                        p.splice(w, 0, O(l)),
                                        m = Math.min(h.length, u.length));
                                    else if (h[w] !== u[v]) {
                                        ...
                                        (o = Math.min(r.newValue, p.length - r.length)) !== r.oldValue) {
                                            ...
                                            for (var y = 0; y < r.length; y += 1)
                                                V(p[o + y], p[r.oldValue + y], {}, !1, !0) || (a = !0);
                                            if (a)
                                                return [(new g).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                                        }
                                    }
                            return b
                        }
                        ...
                        t.prototype.findValueDiff = function(t, e, s) {
                            var i = [];
                            return t.selected !== e.selected && i.push((new g).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                            (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new g).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)),
                            t.checked !== e.checked && i.push((new g).setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)),
                            i
                        }
                        ,
                        t
                    ...
                    const B = (t, e, s, {classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l}, {noColumnWidths: d, unhideHeader: c}) => ({
                        nodeName: "TR",
                        childNodes: t.map(( (t, h) => {
                            ...
                            if (p.sortable && o && (!r.length || c) && (p.filter ? f["data-filterable"] = "true" : f["data-sortable"] = "true"),
                      ...
                      , z = (t, e, s, i, n, a, {classes: r, hiddenHeader: l, header: d, footer: c, format: h, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b}, {noColumnWidths: v, unhideHeader: w, renderHeader: _}, y, D) => {
                        const M = {
                            nodeName: "TABLE",
                            attributes: {
                                ...t
                                ...
                                childNodes: s.map(( ({row: t, index: e}) => {
                                    const s = {
                                        ...
                                        childNodes: t.cells.map(( (t, s) => {
                                            ...
                                            if (d || c || !n.widths[s] || v || (r.attributes.style = u(r.attributes.style, `width: ${n.widths[s]}%;`)),
                                    ...
                                    if (e === a && (s.attributes.class = u(s.attributes.class, r.cursor)),
                                    g) {
                                        const i = g(t, s, e);
                                        if (i) {
                                            if ("string" != typeof i)
                        ...
                        if (M.attributes.class = u(M.attributes.class, r.table),
                        d || c || _) {
                            const t = B(e, i, n, {
                                classes: r,
                                hiddenHeader: l,
                    ...
                    var J = U({
                        ...
                        var x = function() {
                            ...
                            g.diff = function(s, h, u) {
                                var p, f = this, m = N.p(h), g = M(s), b = (g.utcOffset() - this.utcOffset()) * t, v = this - g, w = function() {
                                    return N.m(f, g)
                                };
                                switch (m) {
                                case c:
                            ...
                            e?.tBodies?.length && (o.data = Array.from(e.tBodies[0].rows).map((t => ({
                                ...
                                cells: Array.from(t.cells).map(( (t, e) => {
                                    const i = t.dataset.content ? X(t.dataset.content, s[e]) : ( (t, e) => {
                                        ...
                                        return s.attributes = d(t.attributes),
                                        s
                                    }
                                    )(t, s[e]);
                    ...
                    class nt {
                        ...
                        bindEvents() {
                            ...
                            this.events.reset = p(( () => this.events.updateMenu()), 50),
                    ...
                    s.DataTable = class {
                        ...
                        init() {
                            if (this.initialized || h(this.dom, this.options.classes.table))
                                return !1;
                            this._virtualDOM = A(this.dom, this.options.diffDomOptions || {}),
                        ...
                        _renderTable(t={}) {
                            ...
                            let s = z(this._tableAttributes, this.data.headings, e, this.columns.settings, this.columns._state, this.rows.cursor, this.options, t, this._tableFooters, this._tableCaptions);
                        ...
                        _renderPagers() {
                            ...
                            let t = ( (t, e, s, i, n) => {
                                ...
                                return n.firstLast && a.push(st(i, n.lastText, n)),
                                {
                                    nodeName: "UL",
                                    attributes: {
                        ...
                        _renderSeparateHeader() {
                            ...
                            let e = {
                                ...
                                childNodes: [{
                                    nodeName: "THEAD",
                                    childNodes: [B(this.data.headings, this.columns.settings, this.columns._state, this.options, {
                                        unhideHeader: !0
                                    })]
                                }]
                            };
                            if (e.attributes.class = u(e.attributes.class, this.options.classes.table),
                        ...
                        _bindEvents() {
                            ...
                            this.options.rowNavigation && this.dom.addEventListener("keydown", (t => {
                                if ("ArrowUp" === t.key) {
                                    ...
                                    this.options.rowSelectionKeys.includes(t.key) && this.emit("datatable.selectrow", this.rows.cursor, t, !0)
                            }
                            )),
                            ...
                            if (this.options.destroyable) {
                                if (this.wrapperDOM) {
                                    ...
                                    if (t) {
                                        ...
                                        t.replaceChild(s, this.wrapperDOM),
                                        this.dom = s
                                    } else
                        ...
                        multiSearch(t, e="search") {
                            ...
                            const i = s.map((t => this.columns.settings.map(( (e, s) => {
                                ...
                                return ["base", "accent"].includes(n) && (i = i.map((t => t.toLowerCase()))),
                            ...
                            this.data.data.forEach(( (t, e) => {
                                const n = t.cells.map(( (t, e) => {
                                    ...
                                    const n = s.searchItemSeparator || this.options.searchItemSeparator;
                                    return n ? i.split(n) : [i]
                                }
                                ));
                                i.every(( (e, i) => e.find(( (e, a) => {
                                    if (!e)
                                        return !1;
                                    const o = this.columns.settings[a].searchMethod || this.options.searchMethod;
                                    return o ? o(e, n[a], t, a, s[i].source) : e.find((t => n[a].find((e => e.includes(t)))))
                                }
                        ...
                        insert(t) {
                            ...
                            if (Array.isArray(t)) {
                                ...
                                t.forEach(( (t, i) => {
                                    ...
                                    Object.entries(t).forEach(( ([t,s]) => {
                                        const a = e.indexOf(t);
                                        a > -1 ? n[a] = X(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[e.length] = X(s, this.columns.settings[e.length]),
                                        e.push(t),
                                ...
                                e(t) && (!t.headings || this.hasHeadings || this.hasRows ? t.data && Array.isArray(t.data) && (s = t.data.map((t => {
                                    let e, s;
                                ...
                                ))) : this.data = G(t, void 0, this.columns.settings, this.options.type, this.options.format));
                        ...
                        print() {
                            const t = n("table");
                            let e = z(this._tableAttributes, this.data.headings, this.data.data.map(( (t, e) => ({
                                row: t,
                                index: e
                    ...
                    s.exportCSV = function(t, s={}) {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection)) {
                                ...
                                r = t.pages[i.selection - 1].map((t => t.row));
                        else
                            r = t.data.data;
                        let l = [];
                        if (l[0] = a,
                        l = l.concat(r.map((t => t.cells.filter(( (t, e) => n(e))).map((t => o(t)))))),
                        l.length) {
                            let t = "";
                            if (l.forEach((e => {
                                e.forEach((e => {
                    ...
                    s.exportJSON = function(t, s={}) {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection)) {
                                a = [];
                                for (let e = 0; e < i.selection.length; e++)
                                    a = a.concat(t.pages[i.selection[e] - 1].map((t => t.row)))
                            } else
                                a = t.pages[i.selection - 1].map((t => t.row));
                        else
                            a = t.data.data;
